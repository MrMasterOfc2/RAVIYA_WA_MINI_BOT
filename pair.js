...
const octokit = new Octokit({ auth: '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' });// ඔයා 𝚐𝚒𝚝𝚑𝚞𝚋 𝚝𝚘𝚔𝚎𝚗 එකක් අරන් ඒක දාන්න
const owner = 'raviyamdmini-stack';//𝚐𝚒𝚝𝚑𝚞𝚋 𝙰𝙲𝙲𝙾𝚄𝙽𝚃 එකේ 𝚞𝚜𝚎𝚗𝚊𝚖𝚎 දාන්න 
const repo = 'RAVIYA_WA_MINI_BOT';//𝚐𝚒𝚝𝚑𝚞𝚋 𝚛𝚎𝚙𝚘 එකක් හදලා ඒකේ නම දාන්න
